#ifndef ORDER_BOOK_ITCH_V21_ORDER_BOOK_HPP
#define ORDER_BOOK_ITCH_V21_ORDER_BOOK_HPP
...
public:
   OrderBook(
         ...
         : orders_{orders},
           ...
           last_levels_{
                 asks.empty() ? nullptr : &ask_levels.back(),
                 bids.empty() ? nullptr : &bid_levels.back()},
...
private:
   ...
   void CheckBestPriceLevel(const Order &order) {
      const auto last_level = last_levels_[order.bid];
...
#endif //ORDER_BOOK_ITCH_V21_ORDER_BOOK_HPP
